...
Ctrl+Shift+E = Extract Template xml/document files. Assumes save dialogue is in correct location already
...
Ctrl+Shift+S = Template editing: Update component "Section" (uses clipboard e.g. "h"="History" section)
Ctrl+Shift+C = Template editing: Change section to "Create components as children" with Free text entry
